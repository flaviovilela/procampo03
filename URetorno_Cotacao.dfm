object FrmRetorno_Cotacao: TFrmRetorno_Cotacao
  Left = 225
  Top = 20
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Retorno de Cota'#231#227'o'
  ClientHeight = 530
  ClientWidth = 917
  Color = clWindow
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object MEdtData_Cotacao: TMaskEdit
        Left = 85
        Top = 106
        Width = 62
        Height = 17
        ...
        TabOrder = 8
        Text = '  /  /    '
        OnEnter = MEdtData_CotacaoEnter
        OnExit = MEdtData_CotacaoExit
      end
      ...
      object MEdtData_Retorno: TMaskEdit
        Left = 149
        Top = 106
        Width = 61
        Height = 17
        ...
        TabOrder = 9
        Text = '  /  /    '
        OnEnter = MEdtData_RetornoEnter
        OnExit = MEdtData_RetornoExit
      end
      ...
      object EdtN_Cotacao: TEdit
        ...
        BorderStyle = bsNone
        TabOrder = 7
        OnKeyDown = EdtN_CotacaoKeyDown
        OnKeyPress = EdtN_CotacaoKeyPress
      end
      ...
      object EdtPrazo_Entrega: TEdit
        ...
        BorderStyle = bsNone
        TabOrder = 10
        OnKeyPress = EdtPrazo_EntregaKeyPress
      end
    end
  end
  ...
  object ImgImagens_Comandos: TImageList
    ...
    Top = 8
    Bitmap = {
      494C010109000C00840120002000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
      ...
      
      ...
      
  ...
  object qrycotacao: TADOQuery
    ...
    Left = 424
    Top = 320
    object qrycotacaoCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object qrycotacaoN_Pedido: TStringField
      FieldName = 'N_Pedido'
      Size = 13
    end
    object qrycotacaoCodigo_Cliente: TIntegerField
      FieldName = 'Codigo_Cliente'
    end
    object qrycotacaoCodigo_Condicao_Pagamento: TIntegerField
      FieldName = 'Codigo_Condicao_Pagamento'
    end
    object qrycotacaoOutras_Despesas: TFloatField
      FieldName = 'Outras_Despesas'
    end
    object qrycotacaoTipo_Frete: TStringField
      FieldName = 'Tipo_Frete'
      Size = 3
    end
    object qrycotacaoValor_Frete: TFloatField
      FieldName = 'Valor_Frete'
    end
    object qrycotacaoData_Venda: TDateTimeField
      FieldName = 'Data_Venda'
    end
    object qrycotacaoData_Previsao_Entrega: TDateTimeField
      FieldName = 'Data_Previsao_Entrega'
    end
    object qrycotacaoQtde_Itens: TIntegerField
      FieldName = 'Qtde_Itens'
    end
    object qrycotacaoTotal_Produtos: TFloatField
      FieldName = 'Total_Produtos'
    end
    object qrycotacaoPeso_Total: TFloatField
      FieldName = 'Peso_Total'
    end
    object qrycotacaoDesconto: TFloatField
      FieldName = 'Desconto'
    end
    object qrycotacaoTotal_Pedido: TFloatField
    ...
    object qrycotacaoObservacoes: TStringField
      FieldName = 'Observacoes'
      Size = 300
    end
    object qrycotacaoHora_Entrega: TStringField
  ...
  object qryitens_cotacao: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select IC.* from Itens_Cotacao_Preco_Produto IC'
      '')
    Left = 456
    Top = 320
  ...
  object ds_qry_itens_compra: TDataSource
    DataSet = qryitens_retorno_cotacao
    Left = 440
    Top = 376
  end
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select Pro.Codigo, Pro.Descricao, UM.Sigla from Cadastro_Produto' +
        's Pro'
      'inner join Unidade_Medida UM on (Pro.Codigo_Unidade = UM.Codigo)')
    Left = 384
    Top = 320
    ...
    object ADOQuery1Sigla: TStringField
      FieldName = 'Sigla'
      Size = 5
    end
  end
  object qryitens_retorno_cotacao: TADOQuery
    Connection = DM.ADOConnection1
    CursorType = ctStatic
    OnPostError = qryitens_retorno_cotacaoPostError
    Parameters = <>
    SQL.Strings = (
      'select IRC.* from Itens_Retorno_Cotacao_Preco IRC')
    Left = 408
    Top = 376
    object qryitens_retorno_cotacaoCodigo: TIntegerField
      FieldName = 'Codigo'
    end
    object qryitens_retorno_cotacaoN_Cotacao: TIntegerField
      FieldName = 'N_Cotacao'
    end
    object qryitens_retorno_cotacaoCodigo_Produto: TIntegerField
      FieldName = 'Codigo_Produto'
    end
    object qryitens_retorno_cotacaoQtde: TFloatField
      FieldName = 'Qtde'
      DisplayFormat = '#0.0,0'
    end
    object qryitens_retorno_cotacaoValor_Unitario: TFloatField
      FieldName = 'Valor_Unitario'
      Required = True
      DisplayFormat = '#0.0,0'
    end
    object qryitens_retorno_cotacaoDesconto: TFloatField
      FieldName = 'Desconto'
      Required = True
      OnValidate = qryitens_retorno_cotacaoDescontoValidate
      DisplayFormat = '#0.0,0'
    end
    object qryitens_retorno_cotacaoTipo_Desconto: TStringField
      FieldName = 'Tipo_Desconto'
      Size = 3
    end
    object qryitens_retorno_cotacaoSub_Total: TFloatField
      FieldName = 'Sub_Total'
      DisplayFormat = '#0.0,0'
    end
    object qryitens_retorno_cotacaoDescricao: TStringField
      FieldKind = fkLookup
      FieldName = 'Descricao'
    ...
    object qryitens_retorno_cotacaoUn: TStringField
      FieldKind = fkLookup
      FieldName = 'Un'
      LookupDataSet = ADOQuery1
      LookupKeyFields = 'Codigo'
