...
begin
  ...
  begin
    try
      ...
      Util.Insere_Historico(usuario, 'EXCLUIU MARCA ' + EdtDescricao.Text + '.', TimeToStr(time), exclusao, date);
    except
  ...
  if (achei = false) then
    begin
      ...
      begin
        ...
        try
          ...
          Util.Insere_Historico(usuario, 'CADASTROU MARCA ' + EdtDescricao.Text + '.', TimeToStr(time), insercao, date);
        except
          Mensagem.Impossivel_Executar;
        end;
      end
    ...
    begin
      ...
      try
        ...
        Util.Insere_Historico(usuario, 'ALTEROU MARCA ' + EdtDescricao.Text + '.', TimeToStr(time), alteracao, date);
      except
        Mensagem.Impossivel_Executar;
      end;
      end
...
procedure TFrmCadastro_Marca.Gera_Codigo;
var
  qAux: TADOQuery;
  codigo: integer;
begin
  try
    ...
    begin
      ...
      clear;
      add('select max(Codigo) as codigo from Cadastro_Marca');
      open;
    end;
