object FrmRel_Consulta_Pedido: TFrmRel_Consulta_Pedido
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand2: TQRBand
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.Taxa_Entrega)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.Desconto)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.Acrescimo)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.Valor_Recebido)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr8: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.Troco)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(ADOQuery1.Total_Pedido)'
        Mask = '#0.0,0'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select P.*, IP.*, CP.Descricao as Condicao_Pagamento, CM.Descric' +
        'ao as Mesa, CPP.Descricao as Produto,'
      ...
      'convert (varchar(8),P.Hora_Entrega,114) as Hora_Ent,'
        ...
        'convert (varchar(8),P.Hora_Fechamento,114) as Hora_Fec from Pedi' +
        'do P'
      ''
      'left join Itens_Pedido IP on (P.Codigo = IP.Codigo)'
      
        'left join Cadastro_Produto CPP on (IP.Codigo_Produto = CPP.Codig' +
        'o)'
    ...
    object ADOQuery1Data_Movimento: TDateTimeField
      FieldName = 'Data_Movimento'
    end
    object ADOQuery1Hora_Pedido: TDateTimeField
      FieldName = 'Hora_Pedido'
    end
    object ADOQuery1Hora_Fabricacao: TDateTimeField
      FieldName = 'Hora_Fabricacao'
    end
    object ADOQuery1Hora_Termino: TDateTimeField
      FieldName = 'Hora_Termino'
    end
    object ADOQuery1Hora_Entrega: TDateTimeField
    ...
    object ADOQuery1Codigo_Mesa: TIntegerField
      FieldName = 'Codigo_Mesa'
    end
    object ADOQuery1Codigo_Atendente: TIntegerField
      FieldName = 'Codigo_Atendente'
    end
    object ADOQuery1Codigo_Cliente: TIntegerField
      FieldName = 'Codigo_Cliente'
    end
    object ADOQuery1Codigo_Condicao_Pagamento: TIntegerField
    ...
    object ADOQuery1Taxa_Entrega: TFloatField
    ...
    object ADOQuery1Valor_Recebido: TFloatField
      FieldName = 'Valor_Recebido'
    end
    object ADOQuery1Troco: TFloatField
      FieldName = 'Troco'
    end
    object ADOQuery1Status: TStringField
      FieldName = 'Status'
    end
    object ADOQuery1Codigo_Entregador: TIntegerField
      FieldName = 'Codigo_Entregador'
    end
    object ADOQuery1Codigo_1: TIntegerField
      FieldName = 'Codigo_1'
    end
    object ADOQuery1N_Pedido_1: TStringField
      FieldName = 'N_Pedido_1'
      Size = 15
    end
    ...
    object ADOQuery1Desconto_1: TFloatField
      FieldName = 'Desconto_1'
    end
    object ADOQuery1Valor_Venda: TFloatField
      FieldName = 'Valor_Venda'
    end
    object ADOQuery1Observacao_1: TStringField
      FieldName = 'Observacao_1'
      Size = 500
    end
    object ADOQuery1Condicao_Pagamento: TStringField
      FieldName = 'Condicao_Pagamento'
      Size = 30
    end
    object ADOQuery1Mesa: TStringField
      FieldName = 'Mesa'
      Size = 50
    end
    object ADOQuery1Cliente: TStringField
      FieldName = 'Cliente'
      Size = 50
    end
    object ADOQuery1Atendente: TStringField
      FieldName = 'Atendente'
      Size = 50
    end
    object ADOQuery1Entregador: TStringField
    ...
    object ADOQuery1Hora_Fechamento: TDateTimeField
      FieldName = 'Hora_Fechamento'
    end
    object ADOQuery1Sabor_Borda: TStringField
      FieldName = 'Sabor_Borda'
    end
    object ADOQuery1Hora_Ped: TStringField
      FieldName = 'Hora_Ped'
      ReadOnly = True
      Size = 8
    end
    object ADOQuery1Hora_Fab: TStringField
      FieldName = 'Hora_Fab'
      ReadOnly = True
      Size = 8
    end
    object ADOQuery1Hora_Term: TStringField
      FieldName = 'Hora_Term'
      ReadOnly = True
      Size = 8
    end
    object ADOQuery1Hora_Ent: TStringField
      FieldName = 'Hora_Ent'
      ReadOnly = True
      Size = 8
    end
    object ADOQuery1Hora_Fec: TStringField
      FieldName = 'Hora_Fec'
      ReadOnly = True
      Size = 8
    end
