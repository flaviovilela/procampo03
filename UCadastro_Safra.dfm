object FrmCadastro_Safra: TFrmCadastro_Safra
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Safras'
  ClientHeight = 199
  ClientWidth = 535
  Color = clWindow
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object EdtCultura: TEdit
        ...
        ShowHint = False
        TabOrder = 4
        OnKeyPress = EdtCulturaKeyPress
      end
      object EdtCodigo_Cultura: TEdit
        Left = 0
        Top = 111
        Width = 60
        Height = 17
        ...
        ShowHint = True
        TabOrder = 3
        OnKeyDown = EdtCodigo_CulturaKeyDown
        OnKeyPress = EdtCodigo_CulturaKeyPress
      end
    end
  end
