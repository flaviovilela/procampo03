object FrmConciliacao_Compra: TFrmConciliacao_Compra
  Left = 225
  Top = 20
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Concilia'#231#227'o de Compras'
  ClientHeight = 533
  ClientWidth = 952
  Color = clWindow
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object MEdtData_Pedido: TMaskEdit
        Left = 85
        Top = 34
        Width = 62
        Height = 17
      ...
      object PageControl2: TPageControl
        ...
        object TabSheet2: TTabSheet
          ...
          object DBGrid1: TDBGrid
            ...
            Columns = <
              ...
              item
                ...
                Title.Caption = 'Valor Total Rec.'
                Width = 95
                Visible = True
              end
              item
                Expanded = False
                FieldName = 'Valor_Total_Restante'
                Title.Caption = 'Valor Total Res.'
                Width = 90
                Visible = True
              end>
          end
          ...
          object EdtQtde_Solicitada: TEdit
            Left = 345
            Top = 16
            Width = 72
            Height = 17
          ...
          object EdtValor_Total_Recebido: TEdit
            Left = 619
            Top = 16
            Width = 62
            Height = 17
            ...
            TabOrder = 7
            Text = '0,00'
            OnEnter = EdtValor_Total_RecebidoEnter
          end
          object Edtvalor_Total_Restante: TEdit
            Left = 680
            Top = 16
            Width = 62
            Height = 17
            ...
            TabOrder = 8
            Text = '0,00'
            OnEnter = Edtvalor_Total_RestanteEnter
            OnKeyDown = Edtvalor_Total_RestanteKeyDown
          end
          object EdtQtde_Recebida: TEdit
            Left = 416
            Top = 16
            Width = 72
            Height = 17
      ...
      object EdtN_Pedido: TEdit
        ...
        Width = 85
        Height = 17
        Hint = 'Digite o n'#250'mero do pedido e pressione Enter'
        BevelInner = bvNone
        BevelKind = bkFlat
        BevelOuter = bvRaised
        BorderStyle = bsNone
  ...
  object ImgImagens_Comandos: TImageList
    ...
    Top = 8
    Bitmap = {
      494C010109000C00400120002000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object qrycompra: TADOQuery
    ...
    Left = 320
    Top = 320
    object qrycompraCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object qrycompraN_Pedido: TStringField
      FieldName = 'N_Pedido'
      Size = 13
    end
    object qrycompraCodigo_Cliente: TIntegerField
      FieldName = 'Codigo_Cliente'
    end
    object qrycompraCodigo_Condicao_Pagamento: TIntegerField
      FieldName = 'Codigo_Condicao_Pagamento'
    end
    object qrycompraOutras_Despesas: TFloatField
      FieldName = 'Outras_Despesas'
    end
    object qrycompraTipo_Frete: TStringField
      FieldName = 'Tipo_Frete'
      Size = 3
    end
    object qrycompraValor_Frete: TFloatField
      FieldName = 'Valor_Frete'
    end
    object qrycompraData_Venda: TDateTimeField
      FieldName = 'Data_Venda'
    end
    object qrycompraData_Previsao_Entrega: TDateTimeField
      FieldName = 'Data_Previsao_Entrega'
    end
    object qrycompraQtde_Itens: TIntegerField
      FieldName = 'Qtde_Itens'
    end
    object qrycompraTotal_Produtos: TFloatField
      FieldName = 'Total_Produtos'
    end
    object qrycompraPeso_Total: TFloatField
      FieldName = 'Peso_Total'
    end
    object qrycompraDesconto: TFloatField
      FieldName = 'Desconto'
    end
    object qrycompraTotal_Pedido: TFloatField
    ...
    object qrycompraHora_Entrega: TStringField
  ...
  object qryitens_compra: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select CC.*, P.Descricao, UM.Sigla from Conciliacao_Compra CC'
      'inner join Cadastro_Produtos P on (CC.Codigo_Produto = P.Codigo)'
    ...
    object qryitens_compraQtde_Solicitada: TFloatField
      FieldName = 'Qtde_Solicitada'
    end
    ...
    object qryitens_compraValor_Total_Recebido: TFloatField
      FieldName = 'Valor_Total_Recebido'
    end
    object qryitens_compraValor_Total_Restante: TFloatField
      FieldName = 'Valor_Total_Restante'
    end
