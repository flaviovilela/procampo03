object FrmRel_Consulta_Lancamento_Financeiro_Sintetico_Agrupado_Plano: TFrmRel_Consulta_Lancamento_Financeiro_Sintetico_Agrupado_Plano
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'ADOQuery1.Codigo_Plano'
      FooterBand = QRBand2
      Master = QuickRep1
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'esa, LF.Tipo, LF.Codigo_Cli_For, LF.Historico, LF.Data_Lancament' +
        'o, PL.Data_Vencimento, PL.Data_Pagamento,'
      
        'PL.Valor, Cli.Nome, PL.Cheque, PL.Conta, LF.Codigo_Plano, PF.Des' +
        'cricao as Plano from Lancamento_Financeiro LF'
    ...
    object ADOQuery1Plano: TStringField
      FieldName = 'Plano'
      Size = 300
    end
