unit URel_Consulta_Comparativo_Preco_Cotacao_Selecionado;
...
type
  TFrmRel_Consulta_Comparativo_Preco_Cotacao_Selecionado = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmRel_Consulta_Comparativo_Preco_Cotacao_Selecionado: TFrmRel_Consulta_Comparativo_Preco_Cotacao_Selecionado;
...
procedure TFrmRel_Consulta_Comparativo_Preco_Cotacao_Selecionado.DetailBand1BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  if FrmConsulta_Comparativo_Preco_Cotacao.DBGrid1.SelectedRows.CurrentRowSelected then
    PrintBand:= true
  else
    PrintBand:= false;
end;

procedure TFrmRel_Consulta_Comparativo_Preco_Cotacao_Selecionado.FormCreate(Sender: TObject);
begin
//  if (FrmEscolha_Impressao.preview = true) then
    QuickRep1.Preview;
end;

procedure TFrmRel_Consulta_Comparativo_Preco_Cotacao_Selecionado.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
