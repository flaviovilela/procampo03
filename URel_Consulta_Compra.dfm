object FrmRel_Consulta_Compra: TFrmRel_Consulta_Compra
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 598
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select C.*, IC.*, Forn.Nome, CP.Descricao, P.Descricao, UM.Sigla' +
        ' from Compra C'
      'inner join Itens_Compra IC on (C.N_Pedido = IC.N_Pedido)'
    ...
    object ADOQuery1N_Pedido: TIntegerField
      FieldName = 'N_Pedido'
    end
    object ADOQuery1Data_Pedido: TDateTimeField
      FieldName = 'Data_Pedido'
    end
    object ADOQuery1Hora_Pedido: TStringField
      FieldName = 'Hora_Pedido'
      Size = 10
    end
    object ADOQuery1Data_Previsao_Entrega: TDateTimeField
      FieldName = 'Data_Previsao_Entrega'
    end
    object ADOQuery1Codigo_Fornecedor: TIntegerField
      FieldName = 'Codigo_Fornecedor'
    end
    object ADOQuery1Codigo_Condicao_Pagamento: TIntegerField
      FieldName = 'Codigo_Condicao_Pagamento'
    end
    object ADOQuery1Responsavel: TStringField
    ...
    object ADOQuery1Valor_Frete: TFloatField
      FieldName = 'Valor_Frete'
    end
    object ADOQuery1Outras_Despesas: TFloatField
      FieldName = 'Outras_Despesas'
    end
    object ADOQuery1Qtde_Itens: TIntegerField
      FieldName = 'Qtde_Itens'
    end
    object ADOQuery1Total_Produtos: TFloatField
      FieldName = 'Total_Produtos'
    end
    object ADOQuery1Peso_Total: TFloatField
      FieldName = 'Peso_Total'
    end
    object ADOQuery1Desconto: TFloatField
      FieldName = 'Desconto'
    end
    object ADOQuery1Tipo_Desconto: TStringField
    ...
    object ADOQuery1N_Pedido_1: TIntegerField
    ...
    object ADOQuery1Qtde_Recebida: TFloatField
      FieldName = 'Qtde_Recebida'
    end
    object ADOQuery1Qtde_Restante: TFloatField
    ...
    object ADOQuery1Tipo_Desconto_1: TStringField
      FieldName = 'Tipo_Desconto_1'
      Size = 1
    end
    object ADOQuery1Sub_Total: TFloatField
      FieldName = 'Sub_Total'
    end
    object ADOQuery1Status_1: TStringField
      FieldName = 'Status_1'
      Size = 10
    end
    object ADOQuery1Data_Entrega: TDateTimeField
