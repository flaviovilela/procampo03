...
begin
  ...
  begin
    try
      ...
      Util.Insere_Historico(usuario, 'EXCLUIU SETOR ' + EdtDescricao.Text + '.', TimeToStr(time), exclusao, date);
    except
  ...
  if (achei = false) then
    begin
      ...
      begin
        ...
        try
          ...
          Util.Insere_Historico(usuario, 'CADASTROU SETOR ' + EdtDescricao.Text + '.', TimeToStr(time), insercao, date);
        except
          Mensagem.Impossivel_Executar;
        end;
      end
    ...
    begin
      ...
      try
        ...
        Util.Insere_Historico(usuario, 'ALTEROU SETOR ' + EdtDescricao.Text + '.', TimeToStr(time), alteracao, date);
      except
        Mensagem.Impossivel_Executar;
      end;
      end
...
procedure TFrmCadastro_Setor.EdtCidadeKeyPress(Sender: TObject;
  var Key: Char);
begin
  Util.Somente_Apaga(key);
end;

procedure TFrmCadastro_Setor.EdtCodigo_CidadeKeyPress(Sender: TObject;
  var Key: Char);
begin
  Util.Somente_Apaga(key);
end;

procedure TFrmCadastro_Setor.EdtSetorKeyPress(Sender: TObject; var Key: Char);
begin
  Util.Somente_Apaga(key);
end;
...
procedure TFrmCadastro_Setor.Gera_Codigo;
var
  qAux: TADOQuery;
  codigo: integer;
begin
